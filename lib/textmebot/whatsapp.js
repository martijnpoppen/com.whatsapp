...
class textmebot {
    ...
    async sendTextMessage(recipient, isGroup = false, message, fileUrl = null, fileType) {
        if(isGroup) {
            recipient = await this.getGroupId(recipient);
        }
    ...
    async createWebhook(webhookUrl, apikey) {
